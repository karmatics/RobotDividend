class ArticleContent {
  ...
  static p_scarcity_3() {
      return [
        "The fear isn't really about technology; it's a profound confusion between money and wealth. Money has never been food, housing, or healthcare—it is simply a rationing token engineered for a world where getting anything done required human sweat. For ten thousand years of history, 'no job' and 'no production' were the exact same thing: if people didn't toil in the fields, crops didn't grow and humanity starved. That forged an ironclad instinct in our brains: labor equals income equals survival. But automation breaks that ancient link clean in half. You can now have zero human labor alongside record physical production. When people ask, 'If robots take our jobs, how will we buy food?' they are asking a question that assumes human sweat is still required to bake the bread. But if the machines are already baking it, employment has ceased to be the source of our sustenance—it has merely remained our obsolete gatekeeper for eating it.",
  ...
  static p_hundred_4() {
      return [
        "Notice why this currency standard works—and why it quietly resolves the fear of 'printing money out of thin air.' Unlike gold, whose value depends largely on social convention, milled lumber has direct physical utility: you can always use a standard 2×4 to frame a bedroom, brace a roof, or build furniture. More importantly, the colony cannot simply print infinite Credits, because each Credit represents an actual board produced by the mill. Money here is not wealth itself; it is an honest claim check on real, physical production. Before automation, the rule governing those claim checks is strict: every board and bushel requires human perspiration, so if you don't contribute labor, you don't earn Credits, and without Credits you cannot draw on the warehouse.",
  ...
  static p_trans_2() {
      return [
        "Under the old rules, this looks like an immediate economic catastrophe. If robots take over half the work, half the workforce loses their shifts—and without shifts, they stop earning Credits. But the food in the depot and the timber in the yard didn't vanish; they multiplied. Net of the power, maintenance, and materials required to keep the machines running, the colony's total physical output has surged. The underlying arithmetic is straightforward: if a hundred people require a hundred bushels of grain, and autonomous combines harvest a hundred and fifty, the existence of unemployed workers cannot explain a food shortage. A grocery shelf does not care whether wheat was reaped by a human hand or a robotic arm; it only cares whether someone holds an accounting token to take it home. Letting people go hungry while silos overflow is not an immutable law of economics; it is a failure of bookkeeping.",
        "Look at what happens if the colony clings to its old distribution rules: half the workforce is no longer needed at the mill or the farm, so half the workforce stops earning Credits. But the food in the depot and the timber in the yard didn't vanish—they multiplied. The physical arithmetic is dead simple: if a hundred people need a hundred bushels of grain, and autonomous combines harvest a hundred and fifty, the existence of unemployed citizens cannot explain a food shortage. A grocery shelf does not care whether wheat was reaped by a human arm or a hydraulic actuator; it only cares whether someone has a token to take it home. Letting people go hungry while silos overflow simply because machines did the chores is not an economic law; it is a failure of bookkeeping.",
